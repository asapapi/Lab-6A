    ...
    class Submission {
        ...
        */
        ...
        public static int[] Test1(char[] phrase) {
            ...
            int[] phraseArray = new int[phrase.Length];
        ...
        public static double[] Test2(double[] data) {
            ...
            double[] assortedArray = new double[data.Length] ;
           
            for(int i=0; i < data.Length; i++) {
                double small = 0;
                double large = 0;
                double mean = (small + large) / 2;
                    mean = (small + large) / 2;
                if (assortedArray[0] < data[i]) {
                    small = data[i];
                    
                }
                if(assortedArray[1]> data[i]) {
                    large = data[i];
                }
